...
export const useNodeDescription  = (props: {description?: string, variables?: {[key: string] : any}}) => {
    const [text, setText] = useState<string>(
        props.description ? replaceVariablesWithNames(props.description) : ""
    );

    useEffect(() => {
        if (props.variables && props.description) {
